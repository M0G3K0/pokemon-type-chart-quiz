...
**解決策**: `pt-avatar` コンポーネントを作成 (丸だけでなく角丸にも対応)
...
2. 🚧 **pt-icon** (幅広く使用される、基本コンポーネント) - **進行中**
3. **pt-avatar** (pt-iconに依存するかも)
4. **pt-heading** (シンプルだが効果的)
5. **pt-alert** (pt-iconに依存)
6. **pt-type-badge の汎用化検討** (既存コードのリファクタ)
